...
VALUES 
    ...
    INSERT INTO movies (`genre`, `title`, `duration`, `publication_date`, `description`, `awards`, `costs`, `profit`) VALUES
('Action', 'The Terminator', 107.0, '1984-10-26', 'A human soldier is sent from 2029 to 1984 to stop an almost indestructible cyborg killing machine, sent from the same year, which has been programmed to execute a young woman whose unborn son is the key to humanity\'s future salvation.', 'None', 640000.00, 78660000.00),
('Drama', 'Good Will Hunting', 126.0, '1998-01-09', 'Will Hunting, a janitor at M.I.T., has a gift for mathematics, but needs help from a psychologist to find direction in his life.', 'Academy Award for Best Supporting Actor', 100000.00, 2259000.00),
('Horror', 'A Nightmare on Elm Street', 91.0, '1984-11-16', 'The monstrous spirit of a slain child murderer seeks revenge by invading the dreams of teenagers whose parents were responsible for his untimely death.', 'None', 180000.00, 576000.00),
('Science Fiction', 'E.T. the Extra-Terrestrial', 115.0, '1982-06-11', 'A troubled child summons the courage to help a friendly alien escape Earth and return to his home world.', 'Academy Award for Best Original Score', 10500.00, 7929000.00),
('Adventure', 'The Goonies', 114.0, '1985-06-07', 'In order to save their home from foreclosure, a group of misfits set out to find a pirate\'s ancient valuable treasure.', 'None', 19000.00, 616100.00),
('Romance', 'The Notebook', 124.0, '2004-06-25', 'A poor yet passionate young man falls in love with a rich young woman, giving her a sense of freedom, but they are soon separated because of their social differences.', 'None', 230000.00, 1157000.00),
('Thriller', 'Shutter Island', 138.0, '2010-02-19', 'In 1954, a U.S. Marshal investigates the disappearance of a murderer who escaped from a hospital for the criminally insane.', 'None', 800000.00, 294800.00),
('Fantasy', 'Pan\'s Labyrinth', 118.0, '2006-01-27', 'In the falangist Spain of 1944, the bookish young stepdaughter of a sadistic army officer escapes into an eerie but captivating fantasy world.', 'Academy Award for Best Cinematography', 1900000.00, 835700.00),
('Animation', 'The Lion King', 88.0, '1994-06-24', 'Lion prince Simba and his father are targeted by his bitter uncle, who wants to ascend the throne himself.', 'Academy Award for Best Original Score', 450000.00, 9685000.00),
('Splatter', 'Saw II', 93.0, '2005-10-28', 'A detective and his team must rescue eight people trapped in a factory by the twisted serial killer known as Jigsaw.', 'None', 500000.00, 1477000.00),
('Comedy', 'Dumb and Dumber', 107.0, '1994-12-16', 'After a woman leaves a briefcase at the airport terminal, a dumb limo driver and his dumber friend set out on a hilarious cross-country road trip to Aspen to return it.', 'None', 1600000.00, 240000.00),
('Crime', 'The Departed', 151.0, '2006-10-06', 'An undercover cop and a mole in the police attempt to identify each other while infiltrating an Irish gang in South Boston.', 'Academy Award for Best Picture', 900000.00, 290000.00),
('Mystery', 'The Sixth Sense', 107.0, '1999-08-06', 'A boy who communicates with spirits seeks the help of a disheartened child psychologist.', 'None', 400000.00, 6700000.00),
('Western', 'Unforgiven', 131.0, '1992-08-07', 'Retired Old West gunslinger William Munny reluctantly takes on one last job, with the help of his old partner and a young man.', 'Academy Award for Best Picture', 1400000.00, 159000.00),
('War', 'Apocalypse Now', 147.0, '1979-08-15', 'A U.S. Army officer serving in Vietnam is tasked with assassinating a renegade Special Forces Colonel who sees himself as a god.', 'Academy Award for Best Cinematography', 310000.00, 160000.00),
('Biography', 'The Pursuit of Happyness', 117.0, '2006-12-15', 'A struggling salesman takes custody of his son as he\'s poised to begin a life-changing professional endeavor.', 'None', 550000.00, 307000.00);
