...
CREATE TABLE airlines (
    ...
    `max_speed` Decimal(3,2) not null,
    `flight_hours` decimal(5,2) not null,
);


INSERT INTO airlines(id, producer, country, founded, headquarters, max_seats, max_speed, flight_hours)
    VALUES 
        ...
        ('SAS', 'Denmark', '1953-01-06', 'Copenhagen', '300', '900', '10000.00'),
